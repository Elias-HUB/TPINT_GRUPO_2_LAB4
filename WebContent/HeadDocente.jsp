...
<!-- 			<a class="aHead" href="...">Perfil</a> - -->
				...
				<a class="aHead" href="ServletTutoria?Param1=2">Tutorias</a> -  
				<a class="aHead" id="snap-pm-logout" href="Login.jsp">Salir</a>
			</div>
		</div>
		<div class="topcorner">
		
			<a class="aHead" href="ServletLogin?LogoHead=2" class="topcorner"> <img src="Imagenes/Cabecera.png" width="300px"
				alt="Logo">
			</a>
